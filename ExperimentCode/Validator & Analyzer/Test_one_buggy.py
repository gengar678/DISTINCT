...
# 定义常量
result_json_file_path = "/home/zyx/Desktop/Buggy_Tester/log/deepseek/result_deepseek_5.json"
...
def process_single_project(target_path):
    ...
    Args:
        target_path: 要测试的项目路径，例如 "/tmp/lang_14_buggy/src/test/java/org/apache/commons/lang3"
    ...
    num = parts[2].split('_')[1]  # 提取编号，例如 "lang_14_buggy" 中的 "14"
